////
Adapted from clojure.org's "Learn Clojure" guide, content/guides/learn/functions.adoc.
...
This is enough Java interop to read most Clojure code you'll encounter. We come back to it in much more depth in <<ch-4-2-java-interop,Java Interop>>, once you've got more of the language under your belt.
...
__<<ans-functions,Check your answers>>__
