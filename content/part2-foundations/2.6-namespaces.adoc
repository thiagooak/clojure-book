////
Adapted from clojure.org's "Learn Clojure" guide, content/guides/learn/namespaces.adoc.
...
With namespaces, functions, flow control, and the core collection types in hand, you have everything you need for the next checkpoint: <<ch-2-7-project-checkpoint,building a small CLI tool of your own>>.
