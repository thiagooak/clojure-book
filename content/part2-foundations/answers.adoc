////
Adapted from clojure.org's "Learn Clojure" guide, content/guides/learn/answers.adoc.
...
////
[#ch-2-answers]
= Foundations — Exercise Answers

This page contains solutions to the "Test your knowledge" sections in this part.
